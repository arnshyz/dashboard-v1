  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-neutral-950 text-white">
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(120,119,198,0.6), rgba(120,119,198,0) 70%)",
        }}
      />
      <motion.div
        aria-hidden
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(34,197,94,0.5), rgba(34,197,94,0) 70%)",
        }}
      />
      ...
      {/* Noise layer (optional, via CSS class) */}
        ...
        >
          ...
          <div className="mb-4 flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-lg bg-white/10">
              {/* pakai logo AKAY bila ada */}
              <img src="/akay-logo.png" alt="AKAY" className="h-6 w-6 object-contain" />
            </div>
            <div>
