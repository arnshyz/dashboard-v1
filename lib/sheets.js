...
export const HEADERS = ['date','channel','marketplace','qty','penjualan','modal','biayaIklan','potonganMarketplace','biayaOperasional','gajiKaryawan','pajak','diskon','codFee','biayaPengiriman','biayaLainnya'];
